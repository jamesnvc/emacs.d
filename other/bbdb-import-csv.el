...
(defconst wicked/lookout-bbdb-mapping-table-thunderbird
'(("firstname" "First Name")
  ("lastname" "Last Name")
  ("name" "Display Name")
  "Nickname"
  ...
  "Birth Month"
  "Birth Day"
  ("otherfields" "Custom 1"
  "Custom 2"
  "Custom 3"
  "Custom 4")
  ("notes" "Notes"))
  "Field mappings for Thunderbird-type CSVs exported from Outlook, Gmail, LinkedIn, etc.")
...
(defun wicked/lookout-bbdb-create-entry (name company net addrs phones notes &optional otherfields)
...
(defun wicked/bbdb-import-csv-buffer ()
  ...
  (let ((lookout-bbdb-mapping-table
         wicked/lookout-bbdb-mapping-table-thunderbird))
